...
RAW_DATA_PATH = '/home/zju/RecSys/dataset/wechat_data_raw/'
OUT_PATH = '/home/zju/RecSys/dataset/my_feed_data/'
...
print('............ Preprocess offical Feed_embedding............')
...
df_new_emb.columns = ['feedid'] + ['feed_emb_'+str(i) for i in range(64)]
df_new_emb.to_pickle(f'{OUT_PATH}/feed_embedding_pca_d64.pkl')

# 存为gensim word2vec model格式
raw_mm = dict2model(df_new_emb, df_new_emb.columns[0], df_new_emb.columns[1:], 
                    f'{OUT_PATH}/official_feed_emb_pca.d64.pkl')
